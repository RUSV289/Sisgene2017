...
*/
    ...
    private class RestCosumeAsyncTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            System.out.println("ANTES DE LLAMAR A obtenerAllegadoEncuestada");
            List<Allegado> listAllegado = enviarEncuestaDAO.obtenerAllegadoEncuestada(context, idCabEnc);
            System.out.println("TAMAÑO LISTA Allegado"+ enviarEncuestaDAO.obtenerAllegadoEncuestada(context, idCabEnc).size());
            ...
            System.out.println("1111JASON ENVIAR : " + jsonEnviar);
